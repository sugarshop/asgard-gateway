...
// ToggleDiscordThreadLock ToggleThreadLock locks or unlocks a Discord thread, based on the 'locked' parameter.
...
// DiscordChannelMessageSend Sends a message to a specified Discord channel, either as a reply to another message if a message reference is provided or as a standalone message if the message reference is nil
...
// DiscordChannelMessageEdit discord channel message
